...
private:
  ...
  bool use_DAgger_;
  double horizon_max_;
  void findInitGateIndex();
  bool passed_gate = false;
  double DAgger_threshold_ = 1.5;
  bool init_finished = false;
  ros::ServiceClient state_client;

  bool reverseTrack = false;
  // ros::Publisher DAgger_expand_pub_;

  void resetDesiredState2();
  nav_msgs::Odometry state_estimate_quad_prev_;
  nav_msgs::Odometry state_estimate_quad_prev_prev_;
