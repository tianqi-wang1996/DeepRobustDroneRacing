...
PolynomialTrajectory generateMinimumSnapRingTrajectory(
  ...
  for (int d = 0; d < 3; d++) {
    ...
    // std::cout << "way_point_i: " << way_point_i << std::endl;
    // std::cout << "way_points_d: \n" << way_points_d << std::endl;
    // std::cout << "num_waypoints: \n" << num_waypoints << std::endl;
    // std::cout << "way_points_d(14): \n" << way_points_d(14) << std::endl;
    // std::cout << "way_points_d(13): \n" << way_points_d(13) << std::endl;
...
Eigen::VectorXd generateFVector(
  ...
  // printf("generateFVector\n");
  // printf("num_polynoms: %d\n", num_polynoms);
  // printf("poly_order: %d\n",  poly_order);
  for (int k = 0; k < num_polynoms - 1; k++) {
    ...
    // printf("\n");
    // std::cout << "way_points_1D(k + 1): \n" << way_points_1D(k + 1) << std::endl;
    // std::cout << "way_points_1D(k): \n" << way_points_1D(k) << std::endl;
    // std::cout << "f_k: \n" << f_k << std::endl;
...
Eigen::VectorXd generateRingEqualityConstraintsBVector(
  ...
  // std::cout << "way_points_1D: \n" << way_points_1D << std::endl;
...
Eigen::VectorXd solveQuadraticProgram(const Eigen::MatrixXd& H,
  ...
  // colPivHouseholderQr()
  Eigen::VectorXd x = A_lagrange.ldlt().solve(b_lagrange);

  // std::cout << "b_lagrange:" << b_lagrange << std::endl;
  ...
  // std::cout << "1:" << solution.transpose() << std::endl;
  // std::cout << "2:" << H << std::endl;
  // std::cout << "3:" << solution << std::endl;
  // std::cout << "final 1:" << solution.transpose() * H * solution << std::endl;
  // std::cout << "final 2:" << f.dot(solution) << std::endl;
  // printf(solution.transpose() * H * solution);
  // printf(f.dot(solution));
